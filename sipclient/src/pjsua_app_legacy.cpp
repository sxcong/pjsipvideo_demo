/* $Id: pjsua_app_legacy.c 4739 2014-02-11 04:46:49Z riza $ */
/*
...
static void vid_handle_menu(char *menuin)
{
	...
	if (argc == 5 && strcmp(argv[2], "rx")==0) {
	    ...
	    if (on) param.dir = (pjmedia_dir)(si.info.vid.dir | PJMEDIA_DIR_DECODING);
	    else param.dir = (pjmedia_dir)(si.info.vid.dir & PJMEDIA_DIR_ENCODING);
